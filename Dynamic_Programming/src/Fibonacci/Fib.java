...
public class Fib {
	public static void main(String[] args){
		...
		System.out.println("Initialization	: " + (t1-t0) + "ns. 	N = " + N);
		//System.out.println("Fib recursive	: " + (t2-t1) + "ns. 	N1 =" + N1);
		//System.out.println("Fib memoization	: " + (t3-t2) + "ns. 	N2 =" + N2);
		System.out.println("Fib tabulation	: " + (t4-t3) + "ns. 	N3 =" + N3);
	}
